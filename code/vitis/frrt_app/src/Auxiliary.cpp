...
{
    public:
		inline static char inputData[120024];
		inline static char buff[256];
		inline static  FIL* fptr;

		static int  Read_xrand(Node_RRT_Pos x_rand[12000]){
			int Status;
    	...
    	static int  Read_data( Position_Holonomic &Pos_Init, Position_Holonomichp &Pos_Goal,
