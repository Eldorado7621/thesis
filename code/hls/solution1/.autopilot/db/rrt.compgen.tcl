...
set name rrt_fsub_32ns_32ns_32_9_full_dsp_1
...
set name rrt_sitofp_32ns_32_7_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set ID 167
set hasByteEnable 0
set MemName rrt_Bool_RAM_AUTO_1R1W
...
set ID 168
set hasByteEnable 0
set MemName rrt_x_near_RAM_AUTO_1R1W
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 1000
...
set ID 169
set hasByteEnable 0
set MemName rrt_RRT_Star_Position_x_RAM_AUTO_1R1W
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 10000
...
set ID 170
set hasByteEnable 0
set MemName rrt_RRT_Star_Location_List_RAM_AUTO_1R1W
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 10000
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 171 \
			corename rrt_CTRL_BUS_axilite \
			name rrt_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
			interrupt_mode none \
			is_flushable 0 \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rrt_CTRL_BUS_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dataInStream_TDATA { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dataInStream_TVALID { I 1 bit } dataInStream_TREADY { O 1 bit } dataInStream_TDEST { I 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { XNearStream_TDATA { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { XNearStream_TVALID { O 1 bit } XNearStream_TREADY { I 1 bit } XNearStream_TDEST { O 6 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 186
set RegSliceName rrt_regslice_both
set RegSliceInstName rrt_regslice_both_U
set CoreName ap_simcore_rrt_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
